...
# this script.
#
# Removes Tier 1 + Tier 2 + Tier 3 (~80-90 MB). Tier 3 packages are pure
# dead weight in a kiosk: BookmarkProvider, PartnerBookmarksProvider,
...
#           MusicFX (equalizer UI is unnecessary on the R1 workspace)
# ---------------------------------------------------------------------------
...
#   - DocumentsUI: file picker for Intent.ACTION_OPEN_DOCUMENT. The R1
#     workspace does not need those intents. (Settings is NOT removed —
...
#     - MediaProviderLegacy: kept for stock media and capture paths
